...
public class LoanAmountUpdateMod extends BaseUpdate {

	private static final String DATASET_ID = "LoanAmountEdit";
	@Override
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean arg0, HttpServletRequest arg1, HttpServletResponse arg2)
		...
		if (updateResultBean.hasNext()) {
			...
			BaseUpdate.mapToObject(loanAmount, map);
           try{
				dao.getHibernateTemplate().update(loanAmount);
			}catch(Exception e){
				ExceptionUtil.throwCommonException("更新贷款发生额信息失败");
			}
		}
